 ...
 * <ai-typing-indicator />
 *
 * <ai-typing-indicator [showBackground]="false" />
 *
 * <ai-typing-indicator animation="wave" />
 *
 * <ai-typing-indicator
 ...
 */
@Component({
  selector: 'ai-typing-indicator',
  templateUrl: './typing-indicator.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'ai-typing-indicator-host block',
    '[attr.role]': '"status"',
