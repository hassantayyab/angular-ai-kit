...
export class MarkdownService {
    ...
    renderer.code = ({ text, lang }: { text: string; lang?: string }) => {
      ...
      return `<div class="code-block-wrapper">
        <div class="code-block-header">
          ...
          <button class="code-block-copy" data-code="${encodedCode}" title="Copy code">
            ${COPY_ICON}
          </button>
        </div>
   ...
   * Note: Sanitization disabled to allow copy button in code blocks.
   * The markdown content is already controlled/trusted.
   */
